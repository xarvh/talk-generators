	...
	return _rtfeldman$elm_css$Css$asPairs(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_rtfeldman$elm_css$Css$transform(
...
var _xarvh$elm_slides$Slides_Styles$whiteOnBlack = _elm_lang$core$Native_List.fromArray(
	[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_rtfeldman$elm_css$Css$num(400))
			])),
		...
		_rtfeldman$elm_css$Css_Elements$section(
		_elm_lang$core$Native_List.fromArray(
			[
				_rtfeldman$elm_css$Css$height(
				_rtfeldman$elm_css$Css$px(700)),
				A2(_rtfeldman$elm_css$Css$property, 'background-position', 'center'),
				A2(_rtfeldman$elm_css$Css$property, 'background-size', 'cover'),
		...
		_rtfeldman$elm_css$Css_Elements$code(
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_rtfeldman$elm_css$Css_Elements$pre(
		_elm_lang$core$Native_List.fromArray(
			[
				_rtfeldman$elm_css$Css$padding(
...
var _xarvh$elm_slides$Slides$slideSection = F2(
	function (styleAttributes, fragments) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$style(styleAttributes)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
...
var _xarvh$elm_slides$Slides$urlUpdate = F3(
	function (options, maybeSlideIndex, model) {
		var _p1 = maybeSlideIndex;
		if (_p1.ctor === 'Nothing') {
			return {
				ctor: '_Tuple2',
				_0: model,
...
var _xarvh$elm_slides$Slides$slideIndexParser = _elm_lang$navigation$Navigation$makeParser(_xarvh$elm_slides$Slides$locationToSlideIndex);
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_rtfeldman$elm_css$Css$pct(50)),
									_rtfeldman$elm_css$Css$bottom(_rtfeldman$elm_css$Css$auto),
									_rtfeldman$elm_css$Css$right(_rtfeldman$elm_css$Css$auto),
									_rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$absolute),
...
var _xarvh$elm_slides$Slides$slidesDefaultOptions = {
	...
	keyCodesToMsg: _elm_lang$core$Native_List.fromArray(
		[
			{
...
var _xarvh$elm_slides$Slides$init = F3(
	function (options, slides, maybeSlideIndex) {
		var cmdWindow = A3(
		...
		var _p8 = A3(_xarvh$elm_slides$Slides$urlUpdate, options, maybeSlideIndex, model0);
		var model = _p8._0;
		var urlCmd = _p8._1;
...
var _user$project$Main$elmBlueOnWhite = _elm_lang$core$Native_List.fromArray(
	[
		_rtfeldman$elm_css$Css_Elements$body(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_rtfeldman$elm_css$Css$height(
				_rtfeldman$elm_css$Css$pct(100)),
				_rtfeldman$elm_css$Css$backgroundColor(_user$project$Main$bgColor),
				_rtfeldman$elm_css$Css$color(_user$project$Main$txtColor),
				_rtfeldman$elm_css$Css$fontFamilies(
				_elm_lang$core$Native_List.fromArray(
					['calibri', 'sans-serif'])),
				_rtfeldman$elm_css$Css$fontSize(_user$project$Main$font),
				_rtfeldman$elm_css$Css$fontWeight(
				_rtfeldman$elm_css$Css$num(400))
			])),
		_rtfeldman$elm_css$Css_Elements$h1(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_rtfeldman$elm_css$Css$textAlign(_rtfeldman$elm_css$Css$left),
				_rtfeldman$elm_css$Css$fontSize(_user$project$Main$font),
				_rtfeldman$elm_css$Css$backgroundColor(_user$project$Main$codeBgColor)
			])),
		_rtfeldman$elm_css$Css_Elements$pre(
		_elm_lang$core$Native_List.fromArray(
			[
			...
			if (_p0.ctor === 'Still') {
				...
				if (_p1.ctor === 'LaterSlide') {
					return _elm_lang$core$Native_List.fromArray(
						[
							_rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$absolute),
							A2(_rtfeldman$elm_css$Css$property, 'z-index', '1'),
							A2(
							_rtfeldman$elm_css$Css$property,
							'filter',
...
var _user$project$Main$main = {
	main: A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_xarvh$elm_slides$Slides$md('# Using (random) generators'),
				...
				_xarvh$elm_slides$Slides$mdFragments(
				_elm_lang$core$Native_List.fromArray(
					[' * I made a mistake, did you see it?', ' * Lugging around the `seedX` value is a pain!', ' * It is cluttered and difficult to read!', ' * I generate `extraToppingIndex` even when I don\'t use it'])),
				_xarvh$elm_slides$Slides$mdFragments(
				_elm_lang$core$Native_List.fromArray(
					['Coming from imperative languages, we are used to compose *values*.', '➡ But in a functional language, we compose *functions*.'])),
